from CommanderCart import CardTraderAutomationFinal
import time
...
class MultiCardAutomator:
    def __init__(self):
        self.automator = CardTraderAutomationFinal()
        self.condiciones = {
            "precio_maximo": 1000,
        }
...
def main():
    print("🚀 AUTOMATIZACIÓN CARDTRADER - MÚLTIPLES CARTAS")
    print("=" * 60)
    ...
    multi_automator = MultiCardAutomator()
    
    try:
        print(f"\n✅ Filtros aplicados: Vendedores UE (sin UK) + Cartas Inglés + SOLO NM + Zero")
